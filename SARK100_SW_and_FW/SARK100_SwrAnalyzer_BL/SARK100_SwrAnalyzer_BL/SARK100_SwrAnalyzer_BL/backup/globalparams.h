...
//
#define ANALOG_IO_CONTROL      0x4     //Analog IO Control register (ABF_CR)
#define PORT_0_GLOBAL_SELECT   0x11    //Port 0 global select register (PRT0GS)
#define PORT_0_DRIVE_0         0x51    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0xae    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0xae    //Port 0 drive mode 1 register (PRT0DM2)
