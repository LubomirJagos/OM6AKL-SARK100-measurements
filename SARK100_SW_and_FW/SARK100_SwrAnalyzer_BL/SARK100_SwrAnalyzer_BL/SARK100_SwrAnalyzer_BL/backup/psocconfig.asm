...
export LoadConfig_sark100_swranalyzer_bl
export _LoadConfig_sark100_swranalyzer_bl
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_sark100_swranalyzer_bl
	lcall	LoadConfigTBL_sark100_swranalyzer_bl_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration sark100_swranalyzer_bl
;
;    Load configuration registers for sark100_swranalyzer_bl.
...
;               CUR_PP
;
_LoadConfig_sark100_swranalyzer_bl:
 LoadConfig_sark100_swranalyzer_bl:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_sark100_swranalyzer_bl_Bank0
    mov     X, <LoadConfigTBL_sark100_swranalyzer_bl_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_sark100_swranalyzer_bl_Bank1
    mov     X, <LoadConfigTBL_sark100_swranalyzer_bl_Bank1
