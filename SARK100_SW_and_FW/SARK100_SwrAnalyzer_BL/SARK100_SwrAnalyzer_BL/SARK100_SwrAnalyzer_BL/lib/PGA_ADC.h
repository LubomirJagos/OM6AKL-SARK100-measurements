...
#pragma fastcall16 PGA_ADC_Start
#pragma fastcall16 PGA_ADC_SetPower
#pragma fastcall16 PGA_ADC_SetGain
#pragma fastcall16 PGA_ADC_Stop

//-------------------------------------------------
// Prototypes of the PGA_ADC API.
//-------------------------------------------------
extern void PGA_ADC_Start(BYTE bPowerSetting);     // Proxy class 2
extern void PGA_ADC_SetPower(BYTE bPowerSetting);  // Proxy class 2
extern void PGA_ADC_SetGain(BYTE bGainSetting);    // Proxy class 2
extern void PGA_ADC_Stop(void);                    // Proxy class 1

//-------------------------------------------------
// Register Addresses for PGA_ADC
//-------------------------------------------------

#pragma ioport  PGA_ADC_GAIN_CR0:   0x071
BYTE            PGA_ADC_GAIN_CR0;
#pragma ioport  PGA_ADC_GAIN_CR1:   0x072
BYTE            PGA_ADC_GAIN_CR1;
#pragma ioport  PGA_ADC_GAIN_CR2:   0x073
BYTE            PGA_ADC_GAIN_CR2;
#pragma ioport  PGA_ADC_GAIN_CR3:   0x070
